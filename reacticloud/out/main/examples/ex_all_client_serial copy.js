...
const f0 = sf_1.SF.arr((x) => x + 100, 'client');
const f1 = sf_1.SF.arr((x) => x * 5, 'client');
const f2 = sf_1.SF.arr((x) => x - 2, 'client');
...
//# sourceMappingURL=ex_all_client_serial%20copy.js.map